    ...
    <main class="container">
        ...
        <div class="product-detail-wrapper">
            ...
            <div class="product-detail-image">
                <img src="../<?php echo htmlspecialchars($accessory['hinhanh']); ?>" alt="<?php echo htmlspecialchars($accessory['ten_phukien']); ?>" onerror="this.src='../images/logo.jpg'">
            </div>
            
            <!-- Thông tin chi tiết -->
            <div class="product-detail-info">
                <h1 class="detail-name"><?php echo htmlspecialchars($accessory['ten_phukien']); ?></h1>
                <p class="detail-desc"><?php echo nl2br(htmlspecialchars($accessory['mo_ta'])); ?></p>
                <div class="detail-price"><?php echo number_format($accessory['gia'], 0, ',', '.'); ?> đ</div>
                <div class="detail-stock">Kho: <?php echo $accessory['so_luong']; ?> sản phẩm</div>
        ...
        <div class="product-comments-section">
            ...
            <div class="reviews-list">
                <?php if (empty($reviews)): ?>
                    <p class="no-reviews">Chưa có đánh giá nào cho phụ kiện này. Hãy là người đầu tiên đánh giá!</p>
                <?php else: ?>
