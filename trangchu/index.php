...
if ($bannerQuery && $bannerQuery->num_rows > 0) {
    ...
    $banners = [
        ['image' => '../images/banner.jpg', 'title' => 'Banner 1'],
        ['image' => '../images/bannerkhuyenmai.jpg', 'title' => 'Banner Khuyến Mãi'],
        ['image' => '../images/bannernoibat.png', 'title' => 'Banner Nổi Bật']
    ];
}
...
<body>
    ...
    <main>
        ...
        <section class="products-section container">
            <h2 class="section-title">Sản Phẩm Khăn Giấy</h2>
        ...
        <!-- Phụ Kiện -->
        <section class="products-section container">
            <h2 class="section-title">Phụ Kiện Kèm Theo</h2>
            <div class="product-grid">
